        ...
        <div class="max-w-7xl mx-auto relative z-10">
            ...
            <header class="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex items-center gap-3">
                    <button
                        class="bg-indigo-500/20 hover:bg-indigo-500/40 text-indigo-300 border border-indigo-500/30 px-5 py-2.5 rounded-xl font-medium transition-colors">
                        + Nuevo Evento
                    </button>

                    <Link href="/calendario" @click="isNavigating = true"
                        ...
                        <svg v-if="!isNavigating" class="w-5 h-5 transition-transform group-hover:rotate-12" fill="none"
